        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div class="app-toolbar py-3 py-lg-6">
                <div class="app-container container-xxl d-flex flex-stack">
                    <h1 class="page-heading text-dark fw-bold fs-3 my-0">จัดการคอร์สของฉัน</h1>
                    <a href="{{ route('teacher.courses.create') }}" class="btn btn-primary">สร้างคอร์ส</a>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @forelse ($courses as $course)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="{{ route('teacher.courses.edit', $course) }}" class="btn btn-sm btn-light-warning">แก้ไข</a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
