            ...
            <div class="app-content flex-column-fluid">
                <div class="app-container container-xxl">
                    ...
                    <div class="card mb-6">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.courses.videos.sections.store', $course) }}" class="row g-4">
                                @csrf
                                <div class="col-md-8">
                        ...
                        <div class="card-body">
                            @forelse ($course->sections as $section)
                                <div class="border rounded p-4 mb-5">
                                    <form method="POST" action="{{ route('admin.courses.videos.sections.update', [$course, $section]) }}" class="row g-3">
                                        @csrf
                                        @method('PUT')
                                        <div class="col-md-7">
                                            <label class="form-label">ชื่อหัวข้อ</label>
                                        ...
                                        <div class="col-md-3 d-flex align-items-end justify-content-end gap-2">
                                            ...
                                            <form method="POST" action="{{ route('admin.courses.videos.sections.destroy', [$course, $section]) }}" onsubmit="return confirm('ยืนยันการลบหัวข้อนี้? วิดีโอจะยังอยู่แต่ถูกย้ายเป็นไม่ระบุหัวข้อ');">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    @forelse ($section->videos as $video)
                                        <div class="border rounded p-4 mt-4">
                                            ...
                                            <div class="d-flex justify-content-end mt-2">
                                                <form method="POST" action="{{ route('admin.courses.videos.destroy', [$course, $video]) }}" onsubmit="return confirm('ยืนยันการลบวิดีโอนี้?');">
                                                    @csrf
                                                    @method('DELETE')
